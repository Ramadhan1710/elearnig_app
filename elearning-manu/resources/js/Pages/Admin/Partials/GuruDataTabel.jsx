...
const GuruDataTable = ({
    ...
    const columns = [
        ...
        columnHelper.accessor("nip_guru", {
            cell: (info) => <span>{info.getValue()}</span>,
            header: "NIP",
        }),
        columnHelper.accessor("jns_kelamin_guru", {
            cell: (info) => <span>{info.getValue()}</span>,
        ...
        }),
        {
            cell: (info) => (
                <div className="flex gap-1">
                    <Link
                        href={`/admin/guru/${info.row.original.id}`}
                        className="bg-yellow-400 p-2 rounded hover:bg-amber-500 transition"
                    >
                        <BsEye />
                    </Link>
                    <Link
                        href={`/admin/guru/${info.row.original.id}/edit`}
        ...
        <div className="p-4 mx-auto fill-gray-400 bg-white shadow-md rounded-xl dark:bg-dots-lighter dark:bg-gray-800 selection:bg-red-500 selection:text-white ">
            ...
            <div className="hidden sm:flex items-center justify-end mt-2 gap-2">
                <button
                    ...
                    className=" dark:text-white p-1 border border-gray-500 px-2"
                >
                    {"<"}
                </button>
                <button
                ...
                <label htmlFor="" className="dark:text-white">Show</label>
                <select
