...
const MapelDataTable = ({ data, jumlahmapel }) => {
        ...
        }),
        {
            cell: (info) => (
                <div className="flex gap-1">
                    <Link
                        href={`/admin/mapel/${info.row.original.id}`}
                        className="bg-yellow-400 p-2 rounded hover:bg-amber-500 transition"
                    >
                        <BsEye />
                    </Link>
                    <Link
                        href={`/admin/mapel/${info.row.original.id}/edit`}
        ...
        <div className="p-4 mx-auto fill-gray-400 bg-white shadow-md rounded-xl dark:bg-dots-lighter dark:bg-gray-800 selection:bg-red-500 selection:text-white ">
            <div className="flex justify-between">
                <div className="pb-2 text-gray-600">
                    <p>Total Mata Pelajaran: {jumlahmapel}</p>
                </div>
            </div>
            <div className="flex justify-between mb-2">
                ...
                <div>
                    ...
                    >
                        <AiOutlinePlusCircle /> <span>Tambah</span><span>Mata</span><span>Pelajaran</span>
                    </Link>
                </div>
            </div>
            ...
            <div className="hidden sm:flex items-center justify-end mt-2 gap-2">
                ...
                <label htmlFor="" className='dark:bg-dots-lighter dark:bg-gray-800 selection:bg-red-500 selection:text-white dark:text-white'>Show</label>
                <select
