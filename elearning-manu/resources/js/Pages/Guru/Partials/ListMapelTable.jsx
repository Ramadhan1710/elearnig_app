        ...
        }),
        {
            cell: (info) => (
                <div className="flex gap-1">
                    <Link
                        href={`/guru/mapel/${info.row.original.id}`}
            ...
            <div className="flex justify-between mb-2">
                <div className="w-full flex items-center gap-1">
                    <DebouncedInput
                        ...
                        className="p-2 bg-white rounded-lg border w-3/5 lg:w-1/5 focus:w-4/5 lg:focus:w-1/3 duration-300 dark:bg-gray-800 selection:bg-red-500 selection:text-white"
                        placeholder="Cari Mata Pelajaran Yang Diajar..."
                    />
                </div>
            </div>
