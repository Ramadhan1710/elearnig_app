    ...
    return (
        <div className="bg-white p-6 rounded-xl shadow-md dark:bg-gray-800 selection:bg-red-500 selection:text-white ">
            ...
            <div className="text-xs pt-4 text-gray-600 dark:text-white flex justify-end">
                <Link href={route('guru.mapel.show',{ mataPelajaran: data.id})}>
                    <button className="bg-blue-600 p-2 rounded text-white uppercase font-semibold tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                        detail
                    </button>
                </Link>
            </div>
